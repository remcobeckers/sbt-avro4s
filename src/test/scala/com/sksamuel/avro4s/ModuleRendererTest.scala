...
class ModuleRendererTest extends WordSpec with Matchers {
  ...
  "new ModuleRenderer()" should {
    ...
    "generate coproducts for union types of 3+ non-null types" in {
      val test = new ModuleRenderer()(RecordType("com.sammy", "MyClass", Seq(FieldDef("name", UnionType(PrimitiveType.String, PrimitiveType.Int, PrimitiveType.Boolean))))) shouldBe """//auto generated code by avro4s
        |case class MyClass(
